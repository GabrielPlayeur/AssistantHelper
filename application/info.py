...
class Info(Tk):
    ...
    def fenetre_texte(self):
        ...
        attention = Label(self, text = "Attention, si vous faites une faute d'orthographe, il se peut que le thème ne soit pas trouvé et emmet un temps d'erreur",bg = 'grey',font = ("Arial", 12),wraplength = 490).pack(pady=5,padx=5)
